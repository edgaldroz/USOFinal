...
public class DetalleCategoria extends AppCompatActivity {
    ...
    private void getParameter() {
        ...
        if (_extras != null){
            ...
            txtDetalleCategoria.setText( (myPCategory == 1) ? "\"Conforman un grupo de cifras resultantes de la suma entre un número real y uno de tipo imaginario\"" :
    ...
    void getDataBase(){
        ...
        //Complejos
        myDataBaseTopics.add(new csTemasContenido(109,1,"Raíces de números negativos","Si el contenido de la raíz o radicando es positivo, la raíz tendrá dos soluciones una positiva y otra negativa, pero si el contenido de la raíz es negativo, la raíz no tendrá solución real.",R.drawable.ic_matriz2,false,false));
        myDataBaseTopics.add(new csTemasContenido(111,1,"Números Imaginarios: Potencias de “i”","Para saber cuánto vale una determinada potencia de i, se divide el exponente entre 4, y el resto es el exponente de la potencia equivalente a la dada.",R.drawable.ic_matriz2,false,false));
        myDataBaseTopics.add(new csTemasContenido(112,1,"Operaciones con números complejos: Suma","La suma de números complejos se realiza sumando partes reales entre sí y partes imaginarias entre sí.",R.drawable.ic_matriz2,false,false));
        myDataBaseTopics.add(new csTemasContenido(114,1,"Operaciones con números complejos: Resta","La diferencia de números complejos se realiza restando partes reales entre sí y partes imaginarias entre sí.",R.drawable.ic_matriz2,false,false));
        myDataBaseTopics.add(new csTemasContenido(110,1,"Operaciones con números complejos: Producto","Formalmente presentamos la definición de la multiplicación de dos números complejos.\n(a+bi)⋅(c+di) = (ac−bd)+(ad+bc)i",R.drawable.ic_matriz2,false,false));
        myDataBaseTopics.add(new csTemasContenido(106,1,"Operaciones con números complejos: División","Para dividir dos complejos, se multiplica el dividendo y el divisor por el conjugado de éste, así el divisor pasará a ser un número real",R.drawable.ic_matriz2,false,false));
        myDataBaseTopics.add(new csTemasContenido(108,1,"Operaciones con polares: Producto"," Multiplicación, primero se multiplican los módulos y los ángulos se sumarán: \nZt=Z1*Z2 = Modulo  \n Zt = |Z1| * |Z2| \n  Argumento θT = θ1 + θ2",R.drawable.ic_matriz2,false,false));
        myDataBaseTopics.add(new csTemasContenido(105,1,"Operaciones con polares: División","Para dividir números complejos, basta dividir sus módulos y restar sus argumentos",R.drawable.ic_matriz2,false,false));
        myDataBaseTopics.add(new csTemasContenido(103,1,"Operaciones con polares: potencia","Para elevar a una potencia un número complejo en forma polar se eleva el módulo al exponente y se multiplica el argumento por el exponente.",R.drawable.ic_matriz2,true,false));
        myDataBaseTopics.add(new csTemasContenido(102,1,"Raíces de números complejos","Sean nn un número natural y z un complejo, siendo |z| y θ el módulo y el argumento de z, respectivamente. Las raíces n-ésimas de z (o raíces de orden n) ",R.drawable.ic_matriz2,true,false));
        myDataBaseTopics.add(new csTemasContenido(101,1,"Representación exponencial de números complejos","Una variante de la forma polar se obtiene al tener en cuenta la conocida como fórmula de Euler: e = cos θ + sen θ",R.drawable.ic_matriz2,true,false));
        myDataBaseTopics.add(new csTemasContenido(104,1,"Representación polar a exponencial de complejos","Se puede representar un número complejo cualquiera (z = a +bi ) en forma polar, dando su módulo y su argumento. Esta forma también se llama forma trigonométrica.",R.drawable.ic_matriz2,true,false));
        myDataBaseTopics.add(new csTemasContenido(115,1,"Rectangular a Polar","Calcula la forma polar equivalente de un número en forma rectangular.",R.drawable.ic_matriz2,false,false));
        //Incompleto----2--
        ...
        //matrices
        myDataBaseTopics.add(new csTemasContenido(205,2,"Operaciones con matrices","Suma, resta, multiplicación, producto por un escalar y determinante",R.drawable.ic_matriz2,false,false));
        myDataBaseTopics.add(new csTemasContenido(202,2,"Matriz inversa","La inversa del producto de dos matrices es el producto de las inversas cambiando el orden:\n(A.B)^(-1)=B^(-1).A",R.drawable.ic_matriz2,true,false));
        myDataBaseTopics.add(new csTemasContenido(201,2,"Métodos de Gauss","Este método consiste en colocar junto a la matriz de partida (A) la matriz identidad (I) y hacer operaciones por filas, afectando esas operaciones tanto a A como a I, con el objeto de transformar la matriz A en la matriz identidad, la matriz resultante de las operaciones sobre I es la inversa de A (A-1)",R.drawable.ic_matriz2,true,false));
//        myDataBaseTopics.add(new csTemasContenido(203,2,"Aplicaciones de Sistemas de Ecuaciones Lineales","Es un conjunto de ecuaciones lineales (es decir, un sistema de ecuaciones en donde cada ecuación es de primer grado), definidas sobre un cuerpo o un anillo conmutativo.",R.drawable.ic_matriz,true,false));
        myDataBaseTopics.add(new csTemasContenido(204,2,"Solución de sistemas de ecuaciones lineales","Los sistemas de ecuaciones se clasifican o se distinguen según el número de soluciones que tengan",R.drawable.ic_matriz2,true,false));
